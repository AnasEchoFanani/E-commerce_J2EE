				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							<li class="nav-item"><a class="nav-link" href="user/index.jsp">Home</a></li>
							<li class="nav-item submenu dropdown active">
								...
								<ul class="dropdown-menu">
									...
									<li class="nav-item active"><a class="nav-link" href="user/cart.html">Shopping Cart</a></li>
            ...
            <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                <div class="col-first">
                    ...
                    <nav class="d-flex align-items-center">
                        ...
                        <a href="user/category.html">Cart</a>
                    </nav>
                </div>
            </div>
        </div>
                            ...
                            %>
                                <tr>
                                    <td>
                                        <div class="media">
                                            <div class="d-flex">
                                                <img src="user/img/<%= (produit.getImage() != null) ? produit.getImage() : "" %>" alt="<%= (produit.getNomProduit() != null) ? produit.getNomProduit() : "" %>">
                                            </div>
                                            <div class="media-body">
                                                <p><%= (produit.getNomProduit() != null) ? produit.getNomProduit() : "" %></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <h5>$<%= (produit.getPrix() != null) ? produit.getPrix() : "" %></h5>
                                    </td>
                                </tr>
                            <%
                                }
